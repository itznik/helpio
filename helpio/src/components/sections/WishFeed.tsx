...
const WISHES = [
  ...
  { id: 3, name: "Davide B.", avatar: "https://i.pravatar.cc/150?u=d", wish: "Art Supplies for Portfolio", story: "I am a digital artist trying to get commissions. My drawing tablet broke last week.", amount: 85, category: "Career", verified: false }
];
