  ...
  return (
    <main className="min-h-screen relative flex flex-col">
      ...
      <section className="relative z-10 pt-32 pb-20 px-6 min-h-[85vh] flex flex-col items-center justify-center text-center">
        ...
        >
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 backdrop-blur-sm text-xs font-bold text-slate-700 dark:text-slate-300 mb-8 mx-auto shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="group px-8 py-4 rounded-full border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800/50 text-slate-900 dark:text-white font-semibold text-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center gap-2">
